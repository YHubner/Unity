...
public class TopCameraControl3 : MonoBehaviour {
	...
	void Update()
	{
		...
		{
			GameObject.FindWithTag("TopViewCamera3").GetComponent<Camera>().enabled = true;
			GameObject.FindWithTag("TopViewCamera3").GetComponent<AudioSource>().enabled = true;
		...
		{
			GameObject.FindWithTag("TopViewCamera3").GetComponent<Camera>().enabled = false;
			GameObject.FindWithTag("TopViewCamera3").GetComponent<AudioSource>().enabled = false;
